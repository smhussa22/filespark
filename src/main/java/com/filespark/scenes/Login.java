...
public class Login extends VBox {
    ...
    public Login() {
        ...
        brandText.setStyle("-fx-text-fill: white;" + "-fx-font-size: 16px;" + "-fx-font-weight: bold;");

        HBox topBar = new HBox(10, logo, brandText);
        topBar.setAlignment(Pos.CENTER_LEFT);
        topBar.setPadding(new Insets(20, 24, 12, 24));
