    ...
    return (
        ...
        <div className="bg-black flex items-center justify-center min-h-screen p-10">
            ...
            {mime.startsWith("video/") && (
                ...
                <video src={url} controls autoPlay className="w-full max-w-4xl rounded-xl shadow-lg"/>
            ...
            {!mime.startsWith("video/") && !mime.startsWith("image/") && !mime.startsWith("audio/") && (
                    ...
                    <a href={url} className="text-white underline text-xl" target="_blank" > Download {key} </a>
